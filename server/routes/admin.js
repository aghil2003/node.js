...
router.post('/admin', adminController.checkLogin);
...
router.post('/add-post', authMiddleware, adminController.createPost);
router.get('/edit-post/:id', authMiddleware, adminController.getEditPostPage);
router.put('/edit-post/:id', authMiddleware, adminController.editPost);
